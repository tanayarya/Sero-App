...
struct HowItWorksView: View {
    ...
    private let steps: [(icon: String, title: String, detail: String)] = [
        ("1.circle.fill", "Install Ollama", "Download Ollama from ollama.com and install it on your Mac. It runs as a local server."),
        ("2.circle.fill", "Pull Models", "Open Terminal and run:\nollama pull llama3.2\nollama pull nomic-embed-text"),
        ("3.circle.fill", "Configure Connection", "Open Settings (⚙️) and set your Ollama URL (default: localhost:11434). Test the connection."),
        ("4.circle.fill", "Select Models", "Choose your Chat Model and Embedding Model in Settings. The embedding model powers document search."),
        ("5.circle.fill", "Open a Document", "Click Open Document or drag & drop a PDF, TXT, or Markdown file into the app."),
        ("6.circle.fill", "Start Chatting", "Once the document is processed (shown as Ready ✓), ask questions in the chat panel.")
    ]
